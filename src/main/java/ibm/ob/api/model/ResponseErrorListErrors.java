...
public class ResponseErrorListErrors   {
  ...
  /**
   * Must be one of the following: 0001 â€“ Account not able to be found
   * @return code
  */
  @ApiModelProperty(required = true, value = "Must be one of the following: 0001 â€“ Account not able to be found")
  @NotNull
